...
DATA_FILE = Path(
    r"C:\Users\megido\Downloads\thesis\QUANTUM NETWORKS\data files\data_topology_square_reps_2\Raw_Graph_Data_w_1.0.pkl"
)

# Directory where the autoScale .dat files and results will be saved.
OUTPUT_DIR = Path(
    r"C:\Users\megido\Downloads\thesis\QUANTUM NETWORKS\data files\data_topology_square_reps_2\autoscale_data_percolation"
)
